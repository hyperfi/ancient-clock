      ...
      <div className="flex flex-col gap-8 pb-16 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="w-full mt-6 space-y-3">
              <div className="flex justify-between items-center text-sm font-medium text-stone-600 dark:text-stone-400">
                ...
                <button 
                  ...
                  className="px-3.5 py-1.5 bg-stone-100 dark:bg-stone-800 hover:bg-stone-200 dark:hover:bg-stone-700 rounded-lg text-xs font-semibold text-stone-800 dark:text-stone-200 transition-colors shadow-sm"
                >
              ...
              <input
                ...
                className="w-full h-2.5 bg-stone-200 dark:bg-stone-800 rounded-lg appearance-none cursor-pointer accent-[#4338CA]"
              />
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-[#141210] rounded-2xl p-6 shadow-sm border border-stone-200 dark:border-stone-800 space-y-5">
              <div className="flex items-center justify-between border-b border-stone-100 dark:border-stone-800 pb-3">
                <div>
                  ...
                  <div className="text-2xl text-[#D97706] font-medium flex items-baseline gap-2.5">
                    <span>{tithiInfo.name}</span>
                    <span className="text-xl text-stone-400 font-serif">{tithiInfo.devanagari}</span>
                  </div>
                  <div className="text-sm text-stone-600 dark:text-stone-400 capitalize mt-0.5">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="bg-[#FEFDF5] dark:bg-stone-900/60 p-3.5 rounded-xl border border-stone-100 dark:border-stone-800">
                  ...
                  <div className="text-sm font-semibold text-stone-800 dark:text-stone-200 line-clamp-1">
                    {phaseName}
                  </div>
                </div>
              </div>
        ...
        {/* ========================================================================= */}
        <div className="bg-white dark:bg-[#141210] p-6 rounded-2xl border border-stone-200 dark:border-stone-800 shadow-sm flex flex-col gap-4">
          ...
          <div className="overflow-x-auto pb-2">
            <div className="flex items-center gap-2 min-w-max">
              {Array.from({ length: 30 }).map((_, i) => {
                ...
                const pakshaName = isWaxing ? 'Śukla' : 'Kṛṣṇa';
                ...
                return (
                  <button
                    ...
                    className={`p-2 rounded-xl border flex flex-col items-center gap-1.5 transition-all w-16 text-center ${
                      isCurrent
                        ? 'border-amber-500 bg-amber-50/80 dark:bg-amber-950/60 shadow-md ring-1 ring-amber-500'
                  ...
                  >
                    {renderMoonPhaseSvg(tithiIndex, 24)}
                    <span className="text-[10px] font-mono font-semibold text-stone-800 dark:text-stone-200">
                      T{tithiIndex}
                    </span>
                    <span className="text-[9px] text-stone-500 dark:text-stone-400 line-clamp-1">
